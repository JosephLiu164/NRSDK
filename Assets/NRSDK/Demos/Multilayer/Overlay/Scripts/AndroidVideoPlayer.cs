...
namespace NRKernal.NRExamples
{
    public class AndroidVideoPlayer
    {
        ...
        {
            NRDebugger.Info("[AndroidVideoPlayer] InitWithMediaPlayer : url={0}, drm={1}.", url, usedrm);
        ...
        public void Play()
        {
            Debug.Log("[AndroidVideoPlayer] Play");
            MediaPlayerObject.Call("play");
        }

        public void Pause()
        {
            Debug.Log("[AndroidVideoPlayer] Pause");
            MediaPlayerObject.Call("pause");
        }

        public void Release()
        {
            Debug.Log("[AndroidVideoPlayer] Release");
