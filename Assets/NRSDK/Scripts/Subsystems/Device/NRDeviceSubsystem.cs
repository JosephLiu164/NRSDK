...
namespace NRKernal
{
    ...
    public delegate void SessionEvent(SessionEventType status);
    ...
    public class NRDeviceSubsystem : IntegratedSubsystem<NRDeviceSubsystemDescriptor>
    {
        ...
        public override void Start()
        {
            ...
            NRDebugger.Info("[NRDeviceSubsystem] m_Brightness_Max = {0}", m_Brightness_Max);
#if USING_XR_SDK
        ...
        void OnDisplaySubSystemStart(bool start)
        {
            ...
            if (start && !running)
            {
                ...
                OnSessionEvent?.Invoke(SessionEventType.Resume);
            }
        }
        ...
        public override void Pause()
        {
            ...
            m_NativeHMD?.Pause();
#endif
            OnSessionEvent?.Invoke(SessionEventType.Pause);
