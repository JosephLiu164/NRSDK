...
namespace NRKernal
{
    ...
    internal partial class NativeController
    {
        ...
        public bool Start()
        {
            ...
            NativeResult result = NativeApi.NRControllerStart(m_ControllerHandle);
            NativeErrorListener.Check(result, this, "Start", true);

            int count = GetControllerCount();
            NRDebugger.Info("[NativeController] Get controller count:" + count);
            for (int i = 0; i < count; i++)
            {
                result = NativeApi.NRControllerStateCreate(m_ControllerHandle, i, ref m_StateHandles[i]);
                NativeErrorListener.Check(result, this, "Start ControllerState", true);
            }
        ...
        public void Pause()
        {
            ...
            NativeResult result = NativeApi.NRControllerPause(m_ControllerHandle);
        ...
        public void Resume()
        {
            ...
            NativeResult result = NativeApi.NRControllerResume(m_ControllerHandle);
        ...
        public void Stop()
        {
            ...
            NativeResult result = NativeApi.NRControllerStop(m_ControllerHandle);
        ...
        public void Destroy()
        {
            ...
            NativeResult result = NativeApi.NRControllerDestroy(m_ControllerHandle);
