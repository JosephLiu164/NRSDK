...
namespace NRKernal
{
    ...
    public partial class NativeHMD
    {
        ...
        public bool GetProjectionMatrix(ref EyeProjectMatrixData outEyesProjectionMatrix, float znear, float zfar)
        {
            ...
            NativeResult result_left = NativeApi.NRHMDGetComponentFovInCoord(m_HmdHandle, NativeDevice.LEFT_DISPLAY, ref fov);
            ...
            NativeResult result_right = NativeApi.NRHMDGetComponentFovInCoord(m_HmdHandle, NativeDevice.RIGHT_DISPLAY, ref fov);
            ...
            NativeResult result_RGB = NativeApi.NRHMDGetComponentFovInCoord(m_HmdHandle, NativeDevice.RGB_CAMERA, ref fov);
        ...
        // {
        //     NativeFov4f fov = new NativeFov4f();
        //     The fov value is always positive, never negative, which is not exactly correct.
        ...
        {
            NativeFov4f fov = new NativeFov4f();
            NativeApi.NRHMDGetComponentFovInCoord(m_HmdHandle, device, ref fov);
            return fov;
        }
        ...
        {
            var result = NativeApi.NRHMDGetCameraIntrinsicMatrix(m_HmdHandle, camera, ref CameraIntrinsicMatix);
            return result == NativeResult.Success;
        }
        ...
        public UInt32 GetRefreshRate()
        {
            ...
            var result = NativeApi.NRHMDGetComponentRefreshRate(m_HmdHandle, ref refreshRate);
        ...
        {
            var result = NativeApi.NRHMDGetCameraDistortionParams(m_HmdHandle, camera, ref distortion);
            return result == NativeResult.Success;
        }
        ...
        private struct NativeApi
        {
            ...
            /// <returns> A NativeResult. </returns>
            [DllImport(NativeConstants.NRNativeLibrary)]
            public static extern NativeResult NRHMDGetComponentFovInCoord(UInt64 hmd_handle, NativeDevice component, ref NativeFov4f out_component_fov);
            ...
            public static extern NativeResult NRHMDGetComponentRefreshRate(
                    UInt64 hmd_handle, ref UInt32 out_fresh_rate);
            ...
            /// <param name="hmd_handle">         Handle of the hmd.</param>
            /// <param name="component">          The component.</param>
            /// <param name="out_eye_resolution"> [in,out] Resolution of the component.</param>
            /// <returns> A NativeResult. </returns>
            [DllImport(NativeConstants.NRNativeLibrary)]
